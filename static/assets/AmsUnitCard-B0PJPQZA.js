import { j as jsxRuntimeExports } from "./index-CeSodUhS.js";
import { b as getFillBarColor } from "./amsHelpers-BrH_pr4r.js";
...
function HumidityIndicator({ humidity, goodThreshold = 40, fairThreshold = 60 }) {
  let textColor;
  let DropComponent;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropComponent, { className: "w-3 h-3.5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium tabular-nums text-xs", style: { color: textColor }, children: [
      humidity,
      "%"
    ] })
  ] });
}
function TemperatureIndicator({ temp, goodThreshold = 28, fairThreshold = 35 }) {
  let textColor;
  let ThermoComponent;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThermoComponent, { className: "w-3 h-3.5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium tabular-nums text-xs", style: { color: textColor }, children: [
      temp,
      "°C"
    ] })
...
function SpoolSlot({ tray, slotIndex, isActive, fillOverride, spoolmanFill, onClick }) {
  const isEmpty = isTrayEmpty(tray);
  const color = trayColorToCSS(tray.tray_color);
  const amsFill = tray.remain !== null && tray.remain !== void 0 && tray.remain >= 0 ? tray.remain : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onClick,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-16 h-16 mb-1", children: [
          isEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full rounded-full border-2 border-dashed border-gray-500 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-full bg-gray-600" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 56 56", className: "w-full h-full", children: [
          ...
          isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-1 left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-bambu-green rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-white/70 truncate max-w-full", children: isEmpty ? "Empty" : tray.tray_type || "Unknown" }),
        !isEmpty && effectiveFill !== null && effectiveFill >= 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1 bg-bambu-dark-tertiary rounded-full overflow-hidden mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 text-xs text-white/30", children: slotIndex + 1 })
      ]
    }
  );
}
function AmsUnitCard({ unit, activeSlot, onConfigureSlot, isDualNozzle, nozzleSide, thresholds, fillOverrides, spoolmanFillOverrides }) {
  const trays = unit.tray || [];
  const isHt = unit.is_ams_ht;
  const slotCount = isHt ? 1 : 4;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bambu-dark-secondary rounded-lg p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium text-base", children: getAmsName(unit.id) }),
        isDualNozzle && nozzleSide && /* @__PURE__ */ jsxRuntimeExports.jsx(NozzleBadge, { side: nozzleSide })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        unit.temp != null && /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        unit.humidity != null && /* @__PURE__ */ jsxRuntimeExports.jsx(
          HumidityIndicator,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `grid ${isHt ? "grid-cols-1 max-w-[100px] mx-auto" : "grid-cols-4"} gap-2`, children: Array.from({ length: slotCount }).map((_, i) => {
      const tray = trays[i] || {
        id: i,
        tray_color: null,
        tray_type: "",
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        SpoolSlot,
        {
          ...
          onClick: onConfigureSlot ? () => onConfigureSlot(unit.id, i, isTrayEmpty(tray) ? null : tray) : void 0
        },
        i
      );
    }) })
...
export {
  AmsUnitCard as A,
  HumidityIndicator as H,
  NozzleBadge as N,
  TemperatureIndicator as T
};
