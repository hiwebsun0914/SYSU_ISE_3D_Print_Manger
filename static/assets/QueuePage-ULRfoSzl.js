import { c as createLucideIcon, u as useTranslation, b as useQueryClient, a as useToast, k as useAuth, r as reactExports, d as useQuery, e as useMutation, ab as useQueries, f as api, p as parseUTCDate, j as jsxRuntimeExports, B as Button, y as Card, z as CardContent, D as formatDuration, Q as CircleCheckBig, o as Calendar, X, h as ConfirmModal, O as Layers, E as ExternalLink, q as Link, U as User, ac as Mail, J as Printer, s as formatRelativeTime, P as Power, R as formatETA, l as CircleAlert, ad as BookOpen, _ as CircleX } from "./index-By7NB6Yd.js";
import { u as useSensors, a as useSensor, D as DndContext, c as closestCenter, S as SortableContext, v as verticalListSortingStrategy, b as useSortable, C as CSS, d as arrayMove, s as sortableKeyboardCoordinates, K as KeyboardSensor, P as PointerSensor } from "./sortable.esm-BjQlTOs1.js";
import { P as PrintModal, H as Hand } from "./index-B3Y3YfVS.js";
import { i as isMakerWorldCnModelUrl } from "./makerWorld-CtZm-1Az.js";
import { L as ListOrdered } from "./list-ordered-B9A7kg-Z.js";
...
import { T as Timer } from "./timer-DwrkzaR3.js";
import { T as Trash2 } from "./trash-2-ClCdzOpT.js";
import { A as ArrowUp } from "./arrow-up-irxTbcN6.js";
import { A as ArrowDown } from "./arrow-down-C38gG6V4.js";
...
function isThreemfFilename(filename) {
  return (filename || "").toLowerCase().endsWith(".3mf");
}
function shouldShowLibraryThumbnail(item) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start sm:items-center gap-2 sm:gap-4 p-3 sm:p-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 sm:w-14 sm:h-14 flex-shrink-0 bg-bambu-dark rounded-lg overflow-hidden", children: item.archive_id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: item.plate_id != null ? api.getArchivePlateThumbnail(item.archive_id, item.plate_id) : api.getArchiveThumbnail(item.archive_id, item.archive_thumbnail),
              alt: "",
              className: "w-full h-full object-cover"
            }
          ) : shouldShowLibraryThumbnail(item) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: item.plate_id != null ? api.getLibraryFilePlateThumbnail(item.library_file_id, item.plate_id) : api.getLibraryFileThumbnailUrl(item.library_file_id, item.library_file_thumbnail),
              alt: "",
              className: "w-full h-full object-cover"
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-x-3 gap-y-1 text-xs sm:text-sm text-bambu-gray", children: [
              item.custom_request ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                item.print_time_seconds != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 sm:gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { className: "w-3 h-3 sm:w-3.5 sm:h-3.5" }),
                  formatDuration(item.print_time_seconds)
                ] }),
                item.filament_used_grams != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 sm:gap-1.5", children: [
...
function QueuePage() {
  ...
  const [queueAdminPassword, setQueueAdminPassword] = reactExports.useState(null);
  const [showQueueAdminUnlockModal, setShowQueueAdminUnlockModal] = reactExports.useState(false);
  const [queueAdminPasswordInput, setQueueAdminPasswordInput] = reactExports.useState("");
  const [pendingAdminAction, setPendingAdminAction] = reactExports.useState(null);
  ...
  const unlockQueueAdminMutation = useMutation({
    mutationFn: (password) => api.validateQueueAdminAccess(password),
    onSuccess: (_, password) => {
  ...
  const removeMutation = useMutation({
    mutationFn: ({ id, adminPassword }) => api.removeFromQueue(id, adminPassword),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["queue"] });
  ...
  const requestQueueAdminUnlock = reactExports.useCallback(
    (action) => {
  ...
  const requestQueueRemoval = reactExports.useCallback(
    (item) => {
      requestQueueAdminUnlock({ type: "remove", item });
    },
    [requestQueueAdminUnlock]
  );
  const requestClearHistory = reactExports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-onboarding": "queue-header", className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 sm:gap-4 mb-6", children: [
      ...
      historyItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          title: !canUnlockQueueAdmin ? t("queue.permissions.noAdminAccess") : void 0,
          children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-onboarding": "queue-content", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-bambu-gray", children: t("common.loading") }) : queue?.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-12 text-center border-dashed", children: [
    ...
    showQueueAdminUnlockModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-bambu-dark-secondary rounded-xl border border-bambu-dark-tertiary w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border-b border-bambu-dark-tertiary", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-white", children: t("queue.admin.unlockTitle") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-bambu-gray", children: t("queue.admin.unlockDescription") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white mb-2", children: t("queue.admin.unlockPassword") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "password",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 p-4 border-t border-bambu-dark-tertiary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: unlockQueueAdminMutation.isPending ? t("common.saving") : t("queue.admin.unlockSubmit")
          }
        )
      ] })
    ] }) }),
