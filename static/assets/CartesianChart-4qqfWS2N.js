import { r as reactExports, af as getDefaultExportFromCjs, ag as React, ah as requireReact } from "./index-By7NB6Yd.js";
import { r as reactDomExports } from "./index-DZBj6hbJ.js";
import { w as withSelectorExports } from "./with-selector-B1rnstS8.js";
function r(e) {
  var t, f, n = "";
...
var Rectangle = (rectangleProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$f({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
...
var seed = {};
var initialState$9 = {
  zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current2) => _objectSpread$h(_objectSpread$h({}, acc), {}, {
    [current2]: {
      element: void 0,
...
class LRUCache {
  constructor(maxSize) {
    _defineProperty$f(this, "cache", /* @__PURE__ */ new Map());
...
var Trapezoid = (outsideProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$8({}, svgPropertiesAndEvents(trapezoidProps), {
      ...
      ref: pathRef,
      style: _objectSpread$a(_objectSpread$a({}, animationStyle), trapezoidProps.style)
    }));
  });
};
...
function DotItem(_ref2) {
  ...
  var _ref22 = dotProps !== null && dotProps !== void 0 ? dotProps : {}, {
    points
  } = _ref22, props = _objectWithoutProperties$8(_ref22, _excluded$8);
...
var _excluded$7 = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType"];
...
var _excluded$6 = ["x1", "y1", "x2", "y2", "key"], _excluded2$3 = ["offset"], _excluded3$2 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    var {
      ...
      y2,
      key
    } = lineItemProps, others = _objectWithoutProperties$6(lineItemProps, _excluded$6);
    var _ref22 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(others)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
      offset: __
    } = _ref22, restOfFilteredProps = _objectWithoutProperties$6(_ref22, _excluded2$3);
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$6(props, _excluded3$2);
...
export {
  GraphicalItemClipPath as $,
  isNumOrStr as A,
  rectWithCoords as B,
  CartesianLabelContextProvider as C,
  DefaultZIndexes as D,
  createSelector as E,
  selectChartLayout as F,
  selectChartDataWithIndexesIfNotInPanoramaPosition4 as G,
  selectAxisWithScale as H,
  selectTicksOfGraphicalItem as I,
  selectUnfilteredCartesianItems as J,
  isCategoricalAxis as K,
  Layer as L,
  getBandSizeOfAxis as M,
  propsAreEqual as N,
  SetLegendPayload as O,
  SetCartesianGraphicalItem as P,
  getTooltipNameProp as Q,
  RegisterGraphicalItemId as R,
  Surface as S,
  SetTooltipEntrySettings as T,
  noop$2 as U,
  useNeedsClip as V,
  usePlotArea as W,
  useChartLayout as X,
  getRadiusAndStrokeWidthFromDot as Y,
  ZIndexLayer as Z,
  isClipDot as _,
  adaptEventsOfChild as a,
  Text as a$,
  SetErrorBarContext as a0,
  ActivePoints as a1,
  getValueByDataKey as a2,
  getCateCoordinateOfLine as a3,
  isNullish as a4,
  useAnimationId as a5,
  JavascriptAnimate as a6,
  interpolate$1 as a7,
  LabelListFromLabelProp as a8,
  CartesianLabelListContextProvider as a9,
  selectRenderableAxisSettings as aA,
  selectRealScaleType as aB,
  combineNiceTicks as aC,
  combineAxisDomainWithNiceTicks as aD,
  combineCheckedDomain as aE,
  selectChartOffsetInternal as aF,
  setActiveMouseOverItemIndex as aG,
  mouseLeaveItem as aH,
  setActiveClickItemIndex as aI,
  SetPolarGraphicalItem as aJ,
  findAllByType as aK,
  SetPolarLegendPayload as aL,
  get$1 as aM,
  isNumber as aN,
  mathSign as aO,
  PolarLabelListContextProvider as aP,
  selectActiveTooltipIndex as aQ,
  selectActiveTooltipDataKey as aR,
  selectActiveTooltipGraphicalItemId as aS,
  DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME as aT,
  DATA_ITEM_INDEX_ATTRIBUTE_NAME as aU,
  getMaxRadius as aV,
  getPercentValue as aW,
  polarToCartesian as aX,
  svgPropertiesNoEventsFromUnknown as aY,
  Curve as aZ,
  getClassNameFromUnknown as a_,
  Shape as aa,
  svgPropertiesNoEvents as ab,
  Dots as ac,
  CartesianChart as ad,
  arrayTooltipSearcher as ae,
  ...
  pickAxisType as ak,
  pickAxisId as al,
  itemAxisPredicate as am,
  selectBaseAxis as an,
  combineGraphicalItemsSettings as ao,
  combineGraphicalItemsData as ap,
  selectChartDataAndAlwaysIgnoreIndexes as aq,
  combineDisplayedData as ar,
  combineAppliedValues as as,
  selectAllErrorBarSettings as at,
  combineDomainOfAllAppliedNumericalValuesIncludingErrorValues as au,
  selectDomainDefinition as av,
  selectDomainFromUserPreference as aw,
  combineNumericalDomain as ax,
  selectStackOffsetType as ay,
  combineAxisDomain as az,
  Symbols as b,
  isStacked as b0,
  getStackSeriesIdentifier as b1,
  defaultAxisId as b2,
  selectChartDataWithIndexesIfNotInPanoramaPosition3 as b3,
  selectChartBaseValue as b4,
  selectStackGroups as b5,
  getNormalizedStackId as b6,
  useChartName as b7,
  useCartesianChartLayout as b8,
  isNan as b9,
  Global as ba,
  selectAxisViewBox as bb,
  selectRootMaxBarSize as bc,
  selectBarGap as bd,
  selectBarCategoryGap as be,
  selectRootBarSize as bf,
  selectCartesianAxisSize as bg,
  getBaseValueOfBar as bh,
  truncateByDomain as bi,
  getCateCoordinateOfBar as bj,
  updatePolarOptions as bk,
  RechartsStoreProvider as bl,
  ChartDataContextProvider as bm,
  ReportMainChartProps as bn,
  ReportChartProps as bo,
  CategoricalChart as bp,
  clsx as c,
  useLegendPortal as d,
  useMargin as e,
  useElementOffset as f,
  useChartWidth as g,
  useChartHeight as h,
  useAppDispatch as i,
  setLegendSettings as j,
  setLegendSize as k,
  getUniqPayload as l,
  addLine as m,
  removeLine as n,
  useIsPanorama as o,
  useClipPathId as p,
  selectXAxisSettings as q,
  resolveDefaultProps as r,
  selectLegendPayload as s,
  selectYAxisSettings as t,
  useAppSelector as u,
  selectAxisScale as v,
  useViewBox as w,
  svgPropertiesAndEvents as x,
  CartesianLabelFromLabelProp as y,
  isWellBehavedNumber as z
};
