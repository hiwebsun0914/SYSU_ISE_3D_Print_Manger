import { c as createLucideIcon, u as useTranslation, b as useQueryClient, a as useToast, k as useAuth, aE as useParams, r as reactExports, d as useQuery, e as useMutation, aU as APP_TITLE, f as api, j as jsxRuntimeExports, a3 as Camera, W as WifiOff, l as TriangleAlert, m as getAuthToken } from "./index-CMdmMVx7.js";
...
function CameraPage() {
  ...
  const currentUrl = transitioning ? "" : streamMode === "stream" ? `/api/v1/printers/${id}/camera/stream?fps=15&t=${imageKey}` : `/api/v1/printers/${id}/camera/snapshot?t=${imageKey}`;
