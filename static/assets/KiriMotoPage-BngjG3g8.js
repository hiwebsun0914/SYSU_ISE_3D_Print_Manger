import { u as useTranslation, G as useNavigate, au as useSearchParams, r as reactExports, d as useQuery, j as jsxRuntimeExports, O as Layers, L as LoaderCircle, B as Button, T as TriangleAlert, f as api, aq as getAuthToken } from "./index-CeSodUhS.js";
...
import { A as ArrowUpRight } from "./arrow-up-right-C8YBznnD.js";
let kiriBridgePromise = null;
const KIRI_IFRAME_SANDBOX = "allow-scripts allow-same-origin allow-forms allow-popups allow-popups-to-escape-sandbox allow-downloads";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-bambu-dark-tertiary bg-bambu-dark-secondary/95 px-4 py-3 backdrop-blur md:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-onboarding": "kiri-heading", className: "min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-onboarding": "kiri-workspace", className: "relative flex-1 min-h-0 bg-black", children: [
