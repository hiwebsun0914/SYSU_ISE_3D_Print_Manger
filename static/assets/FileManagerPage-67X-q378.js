import { c as createLucideIcon, u as useTranslation, J as useNavigate, b as useQueryClient, a as useToast, k as useAuth, av as useSearchParams, r as reactExports, d as useQuery, p as parseUTCDate, e as useMutation, j as jsxRuntimeExports, B as Button, L as LoaderCircle, I as Image, a2 as Upload, l as TriangleAlert, g as formatFileSize, X, T as Trash2, f as api, U as User, K as Printer, Q as Layers, h as ConfirmModal, w as ChevronRight, a8 as Archive, H as formatDuration } from "./index-CMdmMVx7.js";
import { P as PrintModal } from "./index-D4wGiEoO.js";
import { u as useIsMobile, M as ModelViewerModal } from "./ModelViewerModal-CHGZViDf.js";
...
import { F as File, a as FileBox } from "./GcodeViewer-CLM1xa0x.js";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-square bg-bambu-dark flex items-center justify-center overflow-hidden", children: [
          file.thumbnail_path ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-2 right-2 text-xs px-1.5 py-0.5 rounded font-medium ${file.file_type === "3mf" ? "bg-bambu-green/90 text-white" : file.file_type === "gcode" ? "bg-blue-500/90 text-white" : file.file_type === "stl" ? "bg-purple-500/90 text-white" : "bg-bambu-gray/90 text-white"}`, children: file.file_type.toUpperCase() })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute bottom-2 right-2 transition-opacity ${isMobile ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`, onClick: (e) => e.stopPropagation(), children: [
          ...
          showActions && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 bottom-8 z-20 bg-bambu-dark-secondary border border-bambu-dark-tertiary rounded-lg shadow-xl py-1 min-w-[140px]", children: [
              ...
              onPreview3d && (file.file_type === "3mf" || file.file_type === "gcode" || file.file_type === "stl") && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group/thumb", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded bg-bambu-dark flex-shrink-0 overflow-hidden", children: file.thumbnail_path ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs px-1.5 py-0.5 rounded font-medium ${file.file_type === "3mf" ? "bg-bambu-green/20 text-bambu-green" : file.file_type === "gcode" ? "bg-blue-500/20 text-blue-400" : file.file_type === "stl" ? "bg-purple-500/20 text-purple-400" : "bg-bambu-gray/20 text-bambu-gray"}`, children: file.file_type.toUpperCase() }) }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", onClick: (e) => e.stopPropagation(), children: [
                  ...
                  (file.file_type === "3mf" || file.file_type === "gcode" || file.file_type === "stl") && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
