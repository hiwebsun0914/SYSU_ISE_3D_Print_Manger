export default {
  ...
  modelLibrary: {
    ...
    subtitle: 'Öffnen Sie MakerWorld von hier, kopieren Sie den Modell-Link und senden Sie ihn direkt an die Warteschlange.',
    embedNoticeTitle: 'MakerWorld wird in einem neuen Tab geöffnet',
    embedNoticeDescription: 'MakerWorld blockiert derzeit das Einbetten durch Dritte, daher verwendet Bambuddy hier einen Öffnen-und-Zurück-Workflow.',
    quickLinksTitle: 'MakerWorld durchsuchen',
    quickLinksDescription: 'Öffnen Sie MakerWorld, suchen Sie das gewünschte Modell, kopieren Sie den Modell-Link und fügen Sie ihn dann in das Formular ein.',
    searchLabel: 'MakerWorld durchsuchen',
    searchPlaceholder: 'Nach Modell, Designer oder Stichwort suchen',
    openSearch: 'MakerWorld suchen',
    openExplore: 'Modellübersicht öffnen',
    howToTitle: 'So funktioniert es',
    howToStep1: '1. Öffnen Sie MakerWorld, um beliebte oder neue Modelle zu durchsuchen.',
    howToStep2: '2. Kopieren Sie den endgültigen Modell-Link, sobald Sie das passende Modell gefunden haben.',
    howToStep3: '3. Fügen Sie den Link hier ein und senden Sie die Anfrage an die Warteschlange.',
    requestTitle: 'MakerWorld-Anfrage senden',
    requestDescription: 'Füllen Sie die folgenden Angaben aus. Die Anfrage wird als manuelle Anfrage zur Warteschlange hinzugefügt.',
    readClipboard: 'Zwischenablage einfügen',
    openModel: 'Link öffnen',
    viewQueue: 'Warteschlange anzeigen',
    submit: 'Zur Warteschlange senden',
    previewLabel: 'Erkanntes Modell:',
    notesPlaceholder: 'Optionale Hinweise zu Größe, Farbe, Druckeinstellungen oder Abholung.',
    permissionHint: 'Sie haben keine Berechtigung, Warteschlangen-Anfragen zu erstellen.',
    toast: {
      clipboardLoaded: 'Link aus Zwischenablage eingefügt',
      clipboardEmpty: 'Zwischenablage ist leer',
      clipboardUnavailable: 'Zwischenablagenzugriff erfordert einen sicheren Browser-Kontext',
      clipboardFailed: 'Zwischenablage konnte nicht gelesen werden',
      requestSubmitted: 'Anfrage an Warteschlange gesendet',
  ...
  settings: {
    ...
    onlineOrcaSlicer: 'OrcaSlicer',
    onlineOrcaSlicerDescription: 'Connect Bambuddy to a browser-accessible OrcaSlicer session so STL files can be sliced with the full Orca desktop UI.',
    onlineOrcaSlicerUrl: 'OrcaSlicer Web URL',
    onlineOrcaSlicerUrlHint: 'Point this at your OrcaSlicer noVNC or remote desktop URL. If needed, you can use the sessionId, inputPath, outputPath, and downloadUrl placeholders.',
    onlineOrcaSlicerEmbed: 'Embed OrcaSlicer in Bambuddy',
    onlineOrcaSlicerEmbedDescription: 'When enabled, the remote OrcaSlicer UI is shown inside Bambuddy. Disable this if your remote desktop blocks iframes.',
