export default {
  ...
  archives: {
    ...
    page: {
      ...
      allMaterials: '所有材料',
      allFiles: '所有文件',
      slicedGcode: '已切片（GCODE）',
      sourceOnly: '仅源文件',
      allTags: '所有标签',
      favorites: '收藏',
      hideFailed: '隐藏失败',
      colors: '颜色：',
      matchAnySelectedColor: '匹配任意已选颜色',
      matchAllSelectedColors: '匹配全部已选颜色',
      createdAutomatically: '打印完成后会自动创建归档',
      noPrinter: '未分配打印机',
  ...
  queue: {
    ...
    request: {
      add: '上传登记',
      edit: '编辑登记',
      description: '登记学号、姓名、接收信息邮箱、MakerWorld 中国模型链接和备注后，会直接进入队列。',
      studentId: '学号',
      requesterName: '姓名',
      contactEmail: '接收信息邮箱',
      ...
      save: '保存登记',
      badge: '人工登记',
      defaultTitle: 'MakerWorld 模型',
      openLink: '打开模型链接',
      status: '登记状态',
      unlockContacts: '查看姓名/邮箱',
      hideContacts: '隐藏姓名/邮箱',
      unlockTitle: '解锁姓名和邮箱',
      unlockDescription: '输入密码后，可查看队列登记中的姓名和接收信息邮箱。',
      unlockPassword: '查看密码',
      unlockSubmit: '解锁查看',
      requiredError: '请填写学号、姓名、接收信息邮箱和 MakerWorld 链接。',
      emailError: '请输入有效的接收信息邮箱。',
      urlError: '请输入 MakerWorld 中国站链接。',
      studentIdValue: '学号：{{value}}',
    ...
    toast: {
      ...
      requestCreated: '登记已加入队列',
      requestCreateFailed: '提交登记失败',
      requestUpdated: '登记已更新',
      requestUpdateFailed: '更新登记失败',
      statusUpdated: '队列状态已更新',
      statusUpdateFailed: '更新队列状态失败',
    ...
    permissions: {
      ...
      unlockContactsFirst: '请先输入密码查看姓名和邮箱',
    },
  },
  ...
  settings: {
    ...
    preferredSlicerDescription: '选择用于打开文件的本地桌面切片协议',
    onlineSlicer: '在线切片器',
    onlineSlicerDescription: '将 Bambuddy 连接到浏览器可访问的 BambuStudio，会以完整桌面界面的方式进行参数选择和切片。',
    onlineSlicerUrl: 'BambuStudio 网页地址',
    onlineSlicerUrlHint: '填写 noVNC 或远程桌面地址。如有需要，可使用 sessionId、inputPath、outputPath 和 downloadUrl 这些占位符。',
    onlineSlicerEmbed: '嵌入到 Bambuddy 中',
    onlineSlicerEmbedDescription: '启用后会直接在 Bambuddy 页面内显示远程切片器。如果远程桌面禁止 iframe，请关闭此项。',
    onlineOrcaSlicer: 'Kiri:Moto',
    onlineOrcaSlicerDescription: '直接在 Bambuddy 中打开 Kiri:Moto，使用纯浏览器方式切片，不再依赖 OrcaSlicer 远程桌面。',
    onlineOrcaSlicerUrl: 'Kiri:Moto 地址',
    onlineOrcaSlicerUrlHint: '默认使用官方地址 https://grid.space/kiri/。如果你有自建或镜像部署，也可以改成可访问的 Kiri:Moto 地址。',
    onlineOrcaSlicerEmbed: '将 Kiri:Moto 嵌入到 Bambuddy 中',
    onlineOrcaSlicerEmbedDescription: '启用后会直接在 Bambuddy 页面内显示 Kiri:Moto。若你更喜欢单独标签页打开，可以关闭此项。',
  ...
  fileManager: {
    ...
    slice: {
      action: '在线切片',
      title: '在线切片',
      description: '使用开源 BambuStudio CLI 在服务器端对这个 STL 进行切片。',
      hint: '会使用已导入的本地打印机、工艺和耗材预设，并生成可打印的 .gcode.3mf 文件。',
      modal: {
        printerPreset: '打印机预设',
        processPreset: '工艺预设',
        filamentPreset: '耗材预设',
        outputFilename: '输出文件名',
        outputPlaceholder: '例如：bracket-online-slice',
        outputHelp: '切片结果会保存为 .gcode.3mf 文件。',
        autoOrient: '自动定向',
        autoOrientHelp: '切片前执行 BambuStudio 自动定向。',
        autoArrange: '自动排布',
        autoArrangeHelp: '切片前将模型自动排布到热床上。',
        missingPresets: '请先在 Profiles 中导入以下本地预设后再切片：{{types}}。',
      },
      submit: '开始切片',
      toast: {
        success: '已创建切片文件：{{filename}}',
        selectAllPresets: '请先选择打印机、工艺和耗材预设。',
      },
    },
  ...
  onlineSlicer: {
    title: '在线切片',
    description: '在浏览器中启动真实的 BambuStudio，会用完整界面进行参数选择和切片。',
    descriptionWithFile: '在浏览器中为 {{filename}} 启动真实的 BambuStudio 在线切片会话。',
    backToFiles: '返回文件管理',
    settings: '设置',
    quickSlice: '快速切片',
    workspaceTitle: '共享工作区',
    workspaceDescription: 'Bambuddy 会把源模型镜像到在线切片工作区。请把切好的结果保存到下面的输出目录，然后再导入回文件库。',
    inputPath: '输入文件',
    outputPath: '输出目录',
    downloadLink: '直链下载地址',
    openDownloadLink: '打开下载地址',
    copyInputPath: '复制输入路径',
    copyOutputPath: '复制输出路径',
    instructionsTitle: '使用步骤',
    importOutputs: '导入切片结果',
    browserTitle: 'BambuStudio 浏览器会话',
    openInNewTab: '新标签页打开',
    preparing: '正在准备在线切片工作区...',
    unavailableTitle: '在线切片器不可用',
    unavailableDescription: '请先配置可访问的 BambuStudio 网页地址，再使用在线切片。',
    openExternallyTitle: '外部窗口模式',
    openExternallyDescription: '当前部署被配置为在单独的浏览器标签页中打开在线切片器。',
    invalidTitle: '缺少源文件',
    invalidDescription: '请从文件管理中的具体文件进入在线切片，这样 Bambuddy 才知道要准备哪个 STL。',
    noActiveSession: '在线切片会话尚未准备完成',
    manualModeTitle: '手动启动',
    manualModeDescription: '你可以直接从侧边栏打开 {{provider}} 手动切片；如果希望自动预载模型并把结果导回 Bambuddy，请从文件管理中的 STL 进入。',
    manualModeHint: '从侧边栏直接进入时不会预先创建共享工作区；如果要让 Bambuddy 自动镜像模型并回收切片结果，请从文件管理进入。',
    instructions: {
      step1: '1. 等待 BambuStudio 从输入路径打开已镜像的模型。',
      step2: '2. 直接在 BambuStudio 中调整打印机、工艺、耗材、支撑、摆盘以及其他切片参数。',
      step3: '3. 将切片结果导出到输出目录，然后点击“导入切片结果”。',
    },
    toast: {
      inputCopied: '已复制在线切片输入路径',
      outputCopied: '已复制在线切片输出路径',
      copyFailed: '复制到剪贴板失败',
      imported: '已导入 {{count}} 个切片文件',
      noOutputs: '在线切片输出目录中没有发现新的切片文件',
    },
  },

  kiriMoto: {
    title: 'Kiri:Moto',
    description: '在浏览器中打开 Kiri:Moto，进行轻量化在线切片。',
    descriptionWithFile: '在浏览器中为 {{filename}} 打开 Kiri:Moto。',
    backToFiles: '返回文件管理',
    settings: '设置',
    openInNewTab: '新标签页打开',
    sourceTitle: '源模型',
    sourceFile: '源文件',
    autoLoadReady: '当 Kiri:Moto 工作区准备完成后，这个 STL 会自动推送进去。',
    autoLoadUnsupported: '目前只有 STL 支持自动载入到 Kiri:Moto。其他格式请先下载源文件，再在 Kiri:Moto 里手动导入。',
    downloadSource: '下载源文件',
    manualLaunchDescription: '如果希望自动预载 STL，请从文件管理进入；如果只是打开空白工作区，直接点侧边栏里的 Kiri:Moto 即可。',
    instructionsTitle: '使用步骤',
    browserTitle: 'Kiri:Moto 工作区',
    unavailableTitle: 'Kiri:Moto 不可用',
    unavailableDescription: '请先配置可访问的 Kiri:Moto 地址，再使用浏览器切片。',
    externalModeTitle: '外部窗口模式',
    externalModeDescription: '当前部署被配置为在单独的浏览器标签页中打开 Kiri:Moto。',
    instructions: {
      step1: '1. 如果希望 Bambuddy 自动预载模型，请从文件管理中打开一个 STL。',
      step2: '2. 直接在 Kiri:Moto 中调整设备和切片参数。',
      step3: '3. 在 Kiri:Moto 中导出 G-code；如果你希望保存在 Bambuddy 文件库里，再把导出的文件上传回文件管理即可。',
    },
    status: {
      loadingBridge: '正在加载 Kiri:Moto 桥接脚本...',
      bridgeFailed: '加载 Kiri:Moto 桥接脚本失败。',
      workspaceReady: 'Kiri:Moto 工作区已就绪。',
      waitingForWorkspace: '正在等待 Kiri:Moto 完成加载...',
      fetchingModel: '正在从 Bambuddy 获取 STL...',
      pushingModel: '正在把 STL 发送到 Kiri:Moto...',
      modelLoaded: '模型已载入 Kiri:Moto。',
      modelLoadFailed: '载入 STL 到 Kiri:Moto 失败。',
    },
    toast: {
      downloadFailed: '下载源文件失败',
    },
  },
  ...
  pendingUploads: {
    title: '待处理上传',
    description: '这些文件通过虚拟打印机上传。确认后归档即可加入你的收藏。',
    placeholders: {
      tags: '例如：功能件、原型、礼物',
      notes: '添加关于此打印的备注...',
    },
    ...
    archiveAll: '全部归档',
    discardAll: '全部丢弃',
    archiveSuccess: '已归档：{{name}}',
    archiveFailed: '归档失败',
    discardSuccess: '上传已丢弃',
    discardFailed: '丢弃上传失败',
    archiveAllSuccess: '已归档 {{archived}} 个文件',
    archiveAllSuccessWithFailed: '已归档 {{archived}} 个文件，{{failed}} 个失败',
    archiveAllFailed: '全部归档失败',
    discardAllSuccess: '已丢弃 {{discarded}} 个文件',
    discardAllFailed: '全部丢弃失败',
    confirmDiscardMessage: '确定要丢弃“{{name}}”吗？此操作无法撤销。',
    confirmArchiveAllMessage: '确定要归档全部 {{count}} 个待处理上传吗？',
    confirmDiscardAllMessage: '确定要丢弃全部 {{count}} 个待处理上传吗？此操作无法撤销。',
    timeAgo: {
      justNow: '刚刚',
      minutesAgo: '{{minutes}} 分钟前',
      hoursAgo: '{{hours}} 小时前',
  ...
  tagManagement: {
    ...
    sortByCount: '按数量排序',
    sortByName: '按名称排序',
    summary: '{{tags}} 个标签，共使用 {{usage}} 次',
    noMatch: '没有匹配搜索的标签',
    empty: '未找到标签',
    renameTag: '重命名标签',
    deleteTag: '删除标签',
    deleteConfirm: '从 {{count}} 个归档中删除“{{name}}”？',
    renameSuccess: '已将“{{oldName}}”重命名为“{{newName}}”，影响 {{count}} 个归档',
    renameFailed: '重命名标签失败',
    deleteSuccess: '已从 {{count}} 个归档中删除“{{name}}”',
    deleteFailed: '删除标签失败',
  },
  ...
  batchTag: {
    titleAdd: '添加标签',
    titleRemove: '移除标签',
    descriptionAdd: '为已选择的 {{count}} 个归档添加标签',
    descriptionRemove: '从已选择的 {{count}} 个归档移除标签',
    addTags: '添加标签',
    removeTags: '移除标签',
    existingTags: '现有标签：',
    tagsToAdd: '将要添加的标签：',
    tagsToRemove: '将要移除的标签：',
    processing: '处理中...',
    updateFailed: '更新标签失败',
    addSuccess: '已为 {{count}} 个归档添加 {{tags}} 个标签',
    removeSuccess: '已从 {{count}} 个归档移除 {{tags}} 个标签',
    placeholders: {
      newTag: '输入新标签...',
    },
  },
  ...
  batchProject: {
    title: '分配到项目',
    description: '将已选择的 {{count}} 个归档分配到项目',
    removeFromProject: '从项目中移除',
    clearProjectAssignment: '清空项目归属',
    orAssignTo: '或分配到',
    projectCount: '{{count}} 个归档',
    noProjects: '还没有项目。可在项目页面创建。',
    assignFailed: '分配项目失败',
    removeFailed: '从项目中移除失败',
    assignSuccess: '已将 {{count}} 个归档加入“{{name}}”',
    removeSuccess: '已将 {{count}} 个归档从项目中移除',
  },
  ...
  compareArchives: {
    ...
    loadFailed: '加载比较结果失败',
    setting: '设置项',
    differencesFound: '发现 {{count}} 处差异',
    moreDifferences: '以及另外 {{count}} 处',
    analysis: '成功/失败分析',
    successful: '{{count}} 个成功',
    failed: '{{count}} 个失败',
    noCorrelations: '未发现设置与结果之间的明显关联。',
    needBothOutcomes: '需要同时包含成功和失败的打印，才能进行关联分析。',
  },
  ...
  projectPageModal: {
    title: '项目页',
    loadFailed: '加载项目页数据失败',
    emptyTitle: '此 3MF 文件中未找到项目页数据。',
    emptyDescription: '项目页通常包含在从 MakerWorld 下载的文件中。',
    titlePlaceholder: '标题',
    designerPlaceholder: '设计师',
    licensePlaceholder: '许可证',
    description: '描述',
    descriptionPlaceholder: '输入描述...',
    printProfile: '打印配置',
    profileTitlePlaceholder: '配置标题',
    profileDescriptionPlaceholder: '配置描述...',
    byAuthor: '作者：{{name}}',
    images: '图片 ({{count}})',
    viewOnMakerWorld: '在 MakerWorld 上查看',
  },
  ...
  // Photo Gallery Modal
  photoGallery: {
    photoCount: '照片 {{current}} / {{total}}',
    deletePhoto: '删除照片',
    deleteConfirm: '删除这张照片吗？此操作无法撤销。',
  },
