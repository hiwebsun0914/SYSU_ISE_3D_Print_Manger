export default {
  ...
  archives: {
    ...
    page: {
      ...
      colors: 'Colors:',
      matchAnySelectedColor: 'Match ANY selected color',
      matchAllSelectedColors: 'Match ALL selected colors',
      createdAutomatically: 'Archives are created automatically when prints complete',
  ...
  queue: {
    ...
    request: {
      add: 'Add Request',
      edit: 'Edit Request',
      description: 'Register a student ID, name, contact email, MakerWorld China model link, and notes to place a manual request into the queue.',
      studentId: 'Student ID',
      requesterName: 'Name',
      contactEmail: 'Contact Email',
      contactEmailPlaceholder: 'name@example.com',
      modelUrl: 'MakerWorld URL',
      notes: 'Notes',
      urlPlaceholder: 'https://makerworld.com.cn/zh/models/...',
      urlHint: 'MakerWorld China links only.',
      submit: 'Submit Request',
      save: 'Save Request',
      badge: 'Manual Request',
      defaultTitle: 'MakerWorld Model',
      openLink: 'Open model link',
      status: 'Request status',
      unlockContacts: 'Reveal Name/Email',
      hideContacts: 'Hide Name/Email',
      unlockTitle: 'Unlock Name and Email',
      unlockDescription: 'Enter the password to reveal the requester name and contact email for queue registrations.',
      unlockPassword: 'View Password',
      unlockSubmit: 'Unlock',
      requiredError: 'Student ID, name, contact email, and MakerWorld URL are required.',
      emailError: 'Please enter a valid contact email.',
      urlError: 'Please enter a MakerWorld China URL.',
      studentIdValue: 'Student ID: {{value}}',
      requesterNameValue: 'Name: {{value}}',
    ...
    toast: {
      ...
      requestCreated: 'Request added to queue',
      requestCreateFailed: 'Failed to submit request',
      requestUpdated: 'Request updated',
      requestUpdateFailed: 'Failed to update request',
      statusUpdated: 'Queue status updated',
      statusUpdateFailed: 'Failed to update queue status',
    ...
    permissions: {
      ...
      unlockContactsFirst: 'Unlock name and email before editing this request',
    },
  },
  ...
  settings: {
    ...
    preferredSlicerDescription: 'Choose which native desktop slicer protocol to use when opening files',
    onlineSlicer: 'Online Slicer',
    onlineSlicerDescription: 'Connect Bambuddy to a browser-accessible BambuStudio session so STL files can be sliced with the full desktop UI.',
    onlineSlicerUrl: 'BambuStudio Web URL',
    onlineSlicerUrlHint: 'Point this at your noVNC or remote desktop URL. If needed, you can use the sessionId, inputPath, outputPath, and downloadUrl placeholders.',
    onlineSlicerEmbed: 'Embed in Bambuddy',
    onlineSlicerEmbedDescription: 'When enabled, the remote slicer UI is shown inside Bambuddy. Disable this if your remote desktop blocks iframes.',
    onlineOrcaSlicer: 'Kiri:Moto',
    onlineOrcaSlicerDescription: 'Open Kiri:Moto directly inside Bambuddy for browser-based slicing without the OrcaSlicer remote desktop stack.',
    onlineOrcaSlicerUrl: 'Kiri:Moto URL',
    onlineOrcaSlicerUrlHint: 'Defaults to the official Kiri:Moto workspace at https://grid.space/kiri/. You can point this at another reachable Kiri:Moto deployment if needed.',
    onlineOrcaSlicerEmbed: 'Embed Kiri:Moto in Bambuddy',
    onlineOrcaSlicerEmbedDescription: 'When enabled, Kiri:Moto is shown directly inside Bambuddy. Disable this if you prefer opening it in a separate tab.',
  ...
  fileManager: {
    ...
    slice: {
      action: 'Slice Online',
      title: 'Online Slice',
      description: 'Slice this STL on the server with the open-source BambuStudio CLI.',
      hint: 'Uses imported local printer, process, and filament presets. The result is saved as a printable .gcode.3mf file.',
      modal: {
        printerPreset: 'Printer Preset',
        processPreset: 'Process Preset',
        filamentPreset: 'Filament Preset',
        outputFilename: 'Output Filename',
        outputPlaceholder: 'e.g., bracket-online-slice',
        outputHelp: 'The sliced result will be saved as a .gcode.3mf file.',
        autoOrient: 'Auto Orient',
        autoOrientHelp: 'Run BambuStudio automatic orientation before slicing.',
        autoArrange: 'Auto Arrange',
        autoArrangeHelp: 'Arrange the model on the bed before slicing.',
        missingPresets: 'Import local presets for {{types}} in Profiles before slicing.',
      },
      submit: 'Slice STL',
      toast: {
        success: 'Created sliced file: {{filename}}',
        selectAllPresets: 'Select printer, process, and filament presets before slicing.',
      },
    },
  ...
  onlineSlicer: {
    title: 'Online Slicer',
    description: 'Launch a real BambuStudio session in the browser for parameter selection and slicing.',
    descriptionWithFile: 'Launch a real BambuStudio session in the browser for {{filename}}.',
    backToFiles: 'Back to Files',
    settings: 'Settings',
    quickSlice: 'Quick Slice',
    workspaceTitle: 'Shared Workspace',
    workspaceDescription: 'Bambuddy mirrors the source model into the online slicer workspace. Save the sliced output into the output folder below, then import it back into the library.',
    ...
    instructionsTitle: 'How To Use It',
    importOutputs: 'Import Sliced Outputs',
    browserTitle: 'BambuStudio Browser Session',
    openInNewTab: 'Open in New Tab',
    preparing: 'Preparing online slicer workspace...',
    unavailableTitle: 'Online slicer unavailable',
    unavailableDescription: 'Configure a reachable BambuStudio Web URL before using online slicing.',
    openExternallyTitle: 'External Window Mode',
    openExternallyDescription: 'This deployment is configured to open the online slicer in a separate browser tab.',
    invalidTitle: 'Missing source file',
    invalidDescription: 'Open online slicing from a file in the File Manager so Bambuddy knows which STL to prepare.',
    noActiveSession: 'Online slicer session is not ready yet',
    manualModeTitle: 'Manual Launch',
    manualModeDescription: 'Open {{provider}} directly from the sidebar to slice manually, or open an STL from File Manager to preload a model and import the sliced output back into Bambuddy.',
    manualModeHint: 'When launched from the sidebar there is no prepared workspace yet; use File Manager if you want Bambuddy to mirror a source model and re-import the results.',
    instructions: {
      step1: '1. Wait for BambuStudio to open the mirrored model from the input path.',
      step2: '2. Adjust printer, process, filament, supports, plate arrangement, and any other slicing parameters directly in BambuStudio.',
      step3: '3. Export the sliced file into the output folder, then click “Import Sliced Outputs”.',
    },
    toast: {
      inputCopied: 'Copied online slicer input path',
      outputCopied: 'Copied online slicer output path',
      copyFailed: 'Failed to copy to clipboard',
      imported: 'Imported {{count}} sliced file(s)',
      noOutputs: 'No new sliced files were found in the online slicer output folder',
    },
  },

  kiriMoto: {
    title: 'Kiri:Moto',
    description: 'Open Kiri:Moto in the browser for lightweight online slicing.',
    descriptionWithFile: 'Open Kiri:Moto in the browser for {{filename}}.',
    backToFiles: 'Back to Files',
    settings: 'Settings',
    openInNewTab: 'Open in New Tab',
    sourceTitle: 'Source Model',
    sourceFile: 'Source File',
    autoLoadReady: 'This STL will be pushed into Kiri:Moto automatically when the workspace is ready.',
    autoLoadUnsupported: 'Kiri:Moto auto-load currently supports STL files only. Download the source file and import it manually inside Kiri:Moto for other formats.',
    downloadSource: 'Download Source File',
    manualLaunchDescription: 'Open Kiri:Moto from File Manager to preload an STL, or use the sidebar entry for a blank workspace.',
    instructionsTitle: 'How To Use It',
    browserTitle: 'Kiri:Moto Workspace',
    unavailableTitle: 'Kiri:Moto unavailable',
    unavailableDescription: 'Configure a reachable Kiri:Moto URL before using browser slicing.',
    externalModeTitle: 'External Window Mode',
    externalModeDescription: 'This deployment is configured to open Kiri:Moto in a separate browser tab.',
    instructions: {
      step1: '1. Open an STL from File Manager if you want Bambuddy to preload the model into Kiri:Moto.',
      step2: '2. Adjust your device and slicing settings directly inside Kiri:Moto.',
      step3: '3. Export the generated G-code from Kiri:Moto, then upload it back into Bambuddy from File Manager if you want to keep it in the library.',
    },
    status: {
      loadingBridge: 'Loading the Kiri:Moto bridge...',
      bridgeFailed: 'Failed to load the Kiri:Moto bridge.',
      workspaceReady: 'Kiri:Moto workspace ready.',
      waitingForWorkspace: 'Waiting for Kiri:Moto to finish loading...',
      fetchingModel: 'Fetching STL from Bambuddy...',
      pushingModel: 'Sending STL into Kiri:Moto...',
      modelLoaded: 'Model loaded into Kiri:Moto.',
      modelLoadFailed: 'Failed to load the STL into Kiri:Moto.',
    },
    toast: {
      downloadFailed: 'Failed to download the source file',
    },
  },
  ...
  pendingUploads: {
    ...
    discardSuccess: 'Upload discarded',
    discardFailed: 'Failed to discard',
    archiveAllSuccess: 'Archived {{archived}} files',
    archiveAllSuccessWithFailed: 'Archived {{archived}} files, {{failed}} failed',
    archiveAllFailed: 'Failed to archive all',
    discardAllSuccess: 'Discarded {{discarded}} files',
    discardAllFailed: 'Failed to discard all',
    confirmDiscardMessage: 'Are you sure you want to discard "{{name}}"? This cannot be undone.',
    confirmArchiveAllMessage: 'Are you sure you want to archive all {{count}} pending uploads?',
    confirmDiscardAllMessage: 'Are you sure you want to discard all {{count}} pending uploads? This cannot be undone.',
    timeAgo: {
      justNow: 'Just now',
      minutesAgo: '{{minutes}}m ago',
      hoursAgo: '{{hours}}h ago',
  ...
  tagManagement: {
    ...
    summary: '{{tags}} tag(s) across {{usage}} usage(s)',
    noMatch: 'No tags match your search',
    empty: 'No tags found',
    renameTag: 'Rename tag',
    deleteTag: 'Delete tag',
    deleteConfirm: 'Delete "{{name}}" from {{count}} archive(s)?',
    renameSuccess: 'Renamed "{{oldName}}" to "{{newName}}" in {{count}} archive(s)',
    renameFailed: 'Failed to rename tag',
    deleteSuccess: 'Deleted "{{name}}" from {{count}} archive(s)',
  ...
  batchTag: {
    titleAdd: 'Add Tags',
    titleRemove: 'Remove Tags',
    descriptionAdd: 'Add tags for {{count}} selected archive(s)',
    descriptionRemove: 'Remove tags for {{count}} selected archive(s)',
    addTags: 'Add Tags',
    ...
    addSuccess: 'Added {{tags}} tag(s) to {{count}} archive(s)',
    removeSuccess: 'Removed {{tags}} tag(s) from {{count}} archive(s)',
    placeholders: {
  ...
  batchProject: {
    ...
    description: 'Assign {{count}} selected archive(s) to a project',
    removeFromProject: 'Remove from project',
    clearProjectAssignment: 'Clear project assignment',
    orAssignTo: 'or assign to',
    projectCount: '{{count}} archive(s)',
    noProjects: 'No projects yet. Create one from the Projects page.',
    assignFailed: 'Failed to assign project',
    removeFailed: 'Failed to remove from project',
    assignSuccess: 'Added {{count}} archive(s) to "{{name}}"',
    removeSuccess: 'Removed {{count}} archive(s) from project',
  },
  ...
  compareArchives: {
    ...
    moreDifferences: '...and {{count}} more',
    analysis: 'Success/Failure Analysis',
    successful: '{{count}} successful',
    failed: '{{count}} failed',
    noCorrelations: 'No clear correlations found between settings and outcomes.',
    needBothOutcomes: 'Need both successful and failed prints for correlation analysis.',
  },

  qrCodeModal: {
    title: 'QR Code',
    scanHint: 'Scan to open this archive',
  ...
  projectPageModal: {
    ...
    emptyTitle: 'No project page data found in this 3MF file.',
    emptyDescription: 'Project pages are typically included in files downloaded from MakerWorld.',
    titlePlaceholder: 'Title',
    designerPlaceholder: 'Designer',
    licensePlaceholder: 'License',
    description: 'Description',
    descriptionPlaceholder: 'Enter description...',
    printProfile: 'Print Profile',
    profileTitlePlaceholder: 'Profile Title',
